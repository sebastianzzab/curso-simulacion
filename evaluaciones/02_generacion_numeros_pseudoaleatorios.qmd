...
<p style="text-align: justify;">El correlograma muestra las autocorrelaciones para diferentes retardos (lags). Para una secuencia independiente, estas autocorrelaciones deberían estar dentro de los límites de confianza (líneas azules). El test de Ljung-Box es la prueba formal asociada.</p>
...
<p style="text-align: justify;">Por estos motivos se aplicara la siguiente metodología para evaluar la calidad del generador sobre múltiples secuencias:</p>
