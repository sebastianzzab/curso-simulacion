...
Este repositorio contiene materiales, notas, ejercicios y recursos utilizados en el curso de **Simulación**. El objetivo es disponer de un espacio organizado para estudiar, practicar y reforzar los conceptos fundamentales de la simulación en estadística y ciencias de datos.
...
Para trabajar con los archivos `.tex`, se recomienda tener instalado:
...
- Sebastian Ernesto Zabala Zabala
  - Licenciatura en Estadística
  - Interesado en modelado estadístico, simulación y ciencia de datos.
